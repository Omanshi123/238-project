# this file manages how the entire app will run. 
...
#re-enters the dummy data into the newly created database
def seeder():
...
#can be used from the terminal directly with a particular command
def rsd():
