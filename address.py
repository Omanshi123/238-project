# python file for all the Address table, that contains the column
# [ID, USER ID, House Number, City, State, Country and pin code] and their types [string or integer]
